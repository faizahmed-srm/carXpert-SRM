...
<div class="container register">
                <div class="row">
                    <div class="col-md-3 register-left">
                        ...
                        <h3>Welcome to CarXpert</h3>
                        <p>You are 30 seconds away from shopping our own product!</p>
                    ...
                    <div class="col-md-9 register-right">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                <h3 class="register-heading">Open Account as User</h3>
    ...
    <form:input path="name" type="text" class="form-control" id="name" aria-describedby="" placeholder="Enter Name"/>
                                        ...
                                        <div class="form-group">
    <form:input path="mobNo" type="number" class="form-control" id="mobNo" minlength="10" maxlength="10" aria-describedby="" placeholder="Enter MobileNumber"/>
                                        </div>
                                        <div class="form-group">
    ...
    <form:input path="country" type="text" class="form-control" id="country" aria-describedby="" placeholder="Enter country"/>
                                        ...
                                        <div class="form-group">
                                            <select class="form-control">
                                                ...
                                                <option>What is your secret Password?</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
